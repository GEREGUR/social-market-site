...
// import {ReactComponent as ReactLogo} from '/Users/geregur/Desktop/React Test SM platform/src/images/#10undermind.svg'

export function Slider(){
    return(
        <div className="mt-2 w-full inline-flex flex-nowrap  border-t-2 border-b-2 border-black overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]">
